...
import static net.deanly.solanarpcj.core.AddressLookupTableAccountTest.createMockAddressLookupTableAccount;
...
class MessageV0Test {
    ...
    private TransactionInstruction createMockInstruction() {
        ...
        return new TransactionInstruction(programId, Collections.singletonList(meta), data);
    }
    ...
    void testSerializationExceedsPacketLimit() {
        ...
        List<TransactionInstruction> instructions = List.of(new TransactionInstruction(
                new PublicKey("SecondPubey22222222222222222222222222222222"),
