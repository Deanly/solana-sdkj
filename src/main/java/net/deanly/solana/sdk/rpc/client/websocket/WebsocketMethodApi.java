...
public interface WebsocketMethodApi {
    ...
    RpcResponse<SubscriptionId> rootSubscribe(NotificationListener<RpcNotification<Long>> listener);
    ...
    RpcResponse<SubscriptionId> slotSubscribe(NotificationListener<RpcNotification<ResValueSlot>> listener);
    ...
    RpcResponse<SubscriptionId> slotsUpdatesSubscribe(NotificationListener<RpcNotification<ResValueSlotUpdates>> listener);
    ...
    RpcResponse<SubscriptionId> voteSubscribe(NotificationListener<RpcNotification<ResValueVote>> listener);
