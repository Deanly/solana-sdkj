...
public class SystemInstruction10AssignWithSeed extends SystemProgram.Base implements TransactionInstruction {
    ...
    public void setKeys(PublicKey accountPubkey, PublicKey basePubkey) {
        ...
        this.keys = List.of(
                new AccountMeta(accountPubkey, true, false), // Target account to be assigned (writable, not signer)
                new AccountMeta(basePubkey, false, true)    // Base pubkey (signer, not writable)
        );
    }
     ...
     * @param programId     Public key of the program to assign as the new owner.
    ...
    public static SystemInstruction10AssignWithSeed create(
        ...
        if (accountPubkey == null || basePubkey == null || seed == null || programId == null) {
