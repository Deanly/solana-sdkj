package net.deanly.solana.sdk.program.spl.token.basic;
 ...
 */
public class SplTokenProgramTest {
    ...
    public void testInitializeMint() {
        ...
        assertEquals(Sysvar.SYSVAR_RENT_ADDRESS, instruction.getKeys().get(1).getPublicKey());
