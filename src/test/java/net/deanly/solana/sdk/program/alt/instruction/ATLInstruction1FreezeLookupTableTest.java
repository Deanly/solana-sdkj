...
import net.deanly.solana.sdk.program.spl.alt.instruction.ATLInstruction1FreezeLookupTable;
...
class ATLInstruction1FreezeLookupTableTest {

    @Test
    void testFreezeLookupTableInstruction() {
        // Test data
        ...
        ATLInstruction1FreezeLookupTable decodedInstruction = StructLayout.decode(encodedData, ATLInstruction1FreezeLookupTable.class);
