...
import net.deanly.solanarpcj.utils.PublicKeySerializer;
...
public class PublicKey {
    ...
    public PublicKey(String pubkey) {
        ...
        if (decoded.length != PUBLIC_KEY_LENGTH) {
            throw new IllegalArgumentException("Invalid public key input: length must be exactly " + PUBLIC_KEY_LENGTH + ", " + pubkey);
        }
        this.pubkey = decoded;
    }
