package net.deanly.solanarpcj.manager;
...
import net.deanly.solanarpcj.rpc.RpcException;
import net.deanly.solanarpcj.token.TokenManager;
...
public class TokenManagerTest {
    ...
    public void testTransferCheckedToSolAddress() throws RpcException {
        long amount = 1000L;
        byte decimals = 9;
        PublicKey destinationATA = new PublicKey("SecondPubey22222222222222222222222222222222"); // Example destination ATA
        String expectedTxId = "MockTransactionId";
    ...
    public void testInitializeAccount() throws RpcException {
        ...
        PublicKey usdcTokenMint = new PublicKey("SecondPubey22222222222222222222222222222222"); // Example USDC mint
        String expectedTxId = "MockTransactionId";
    ...
    public void testTransferSOL() throws RpcException {
        ...
        PublicKey recipient = new PublicKey("SecondPubey22222222222222222222222222222222"); // Example recipient address
